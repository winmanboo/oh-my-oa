    ...
    FastAutoGenerator.create("jdbc:mysql://localhost:3306/oh-my-oa?serverTimezone=GMT%2B8&useSSL=false", "root", "mingge123")
        .globalConfig(builder -> {
          builder.author("winmanboo") // 设置作者
              ...
              .outputDir("/Users/wangzhiming/Downloads"); // 指定输出目录
        })
        .packageConfig(builder -> {
          builder.parent("com.winmanboo") // 设置父包名
              .moduleName("oa_my_oa") // 设置父包模块名
              .controller("controller")
              .service("service")
              .mapper("mapper")
              .pathInfo(Collections.singletonMap(OutputFile.xml, "/Users/wangzhiming/Downloads")); // 设置mapperXml生成路径
        })
